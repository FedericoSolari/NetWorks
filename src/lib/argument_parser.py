...
from lib.constants import STOP_AND_WAIT ,SELECTIVE_REPEAT

#Usando el parser de la libreria de python indicamos cuales son los posibles parametros
#que se pueden ingresar por terminal cuando el client hace un upload, y definimos que hace/significa cada uno
